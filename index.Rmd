...
Now let's check Nov 28 to Jan 28, which were extremely cloudy months... it shows 2712 kWh consumed, and 123 kWh returned. 
...
consumption.data %>%
  ...
  summarise(total_consumed  = sum(kw_consumed, na.rm = TRUE),
            total_returned = sum(kw_returned, na.rm = TRUE))
```
OK, so now we have the data matching exactly, as we'd expect!
...
That's pretty amazing... we're through the most cloudy period of the year (Nov/Dec/Jan), and we produced almost 79% of our energy needs.
