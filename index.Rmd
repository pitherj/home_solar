...
```{r breakeven_plot, echo=FALSE, fig.cap="Figure 7: Cumulative estimated electricity savings from the solar array. Filled circles show actual annual savings; triangles show projected savings based on average production from full calendar years at the 2025 electricity rate ($0.1496/kWh). Horizontal dashed lines mark the simple break-even (recovering the $20,000 net investment) and the financed break-even (recovering principal plus interest at 3.24% over 25 years)."}
