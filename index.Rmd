...
Our latest bill (from May 25 to July 17, 2023) shows our net metering "bank" has a balance of 3419kWh.  That's huge. 

```{r}
new_net <- all_data %>%
  filter(day > "2023-07-17") %>%
...
And based on our solar and downloaded Fortis data, since July 17th we have produced a net amount of `r new_net$excess_kWh`.  Adding this to the existing bank balance we get `r new_net$excess_kWh + 3419` kWh banked.
...
Recall that these BEP times are shorter than they would be for a typical household, because we generally consume less energy yearly than a typical household.
