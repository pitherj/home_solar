...
So we see a substantial drop in 2023.  In July 2022 is when we installed the solar.  
...
Our latest bill (from Sept 17 2023 to November 16, 2023) shows our net metering "bank" has a balance of 5048 kWh.  
...
Last year (which was really cold from early November) from November 5th through March 31st we used:
...
So we should have `r winter_usage + 5048` buffer in banked hours. 
