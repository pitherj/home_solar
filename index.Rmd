...
**NOTE** As of 2023, there doesn't appear to be a tiered billing system anymore.
...
At this stage we won't have realized the full potential annual savings of the system, because we only started banking kWh on July 15th 2022.  Even though our total annual energy consumption has increased due to our short term rental (from around 10mWh to what I estimate will be 14mWh), I anticipate we'll bank enough energy in the summer to cover all the winter demand (again, the rental A/C is an unknown variable).  If so, we'll be saving about $1900 per year.

Let's see what our bills say so far...
...
In future, we'll use the hourly solar and Fortis consumption data to repeat these calculations, so see how they compare.
