...
**NOTE** As of 2023, there doesn't appear to be a tiered billing system anymore.  It's fixed at **\$0.13266**.
...
We don't yet have a full years' data to accurately estimate the last variable. 
...
```{r}
kbl(meter.data, caption = "Summary of data from bills from July 28 2022 to April 5 2023.", 
    booktabs = TRUE, digits = c(2, 2, 2, 2, 2)) %>% 
  kable_styling(latex_options = c("scale_down", "hold_position"), position = "center")
```
