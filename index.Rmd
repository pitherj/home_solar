...
Fortis BC has a [net metering program](https://www.fortisbc.com/services/electricity-services/generating-your-own-electricity/net-metering), in which any energy produced by the solar array that is not used immediately on site is put back into the grid. Fortis currently pays out $0.05/kWh for energy supplied to the grid. This is exactly half the rate paid out by BC Hydro. So if you want to calculate what your return on investment would be for solar, be sure to think about this, and have a look at the [map of BC](https://www.bchydro.com/content/dam/BCHydro/customer-portal/documents/corporate/safety/bchydro-service-area-map.pdf) showing the distribution of electricity providers.  
...
Despite valiant efforts by a helpful Fortis customer service employee, Fortis was unable to provide me historical consumption data in any format that was readily useable.  They're working on improving this...
...
Here's what the first few rows of the June 1st onwards data look like:
...
In theory, the difference between the total solar produced and total energy returned to the grid should equal the total energy consumed from the grid.  The numbers are a bit off.  
