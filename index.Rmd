...
```{r echo = FALSE, fig.cap = "Hourly energy output (kWh) for the 36-panel solar array, starting July 8, 2022."}
solar.data %>%
...
```{r echo = FALSE, fig.cap = "Daily energy output (kWh) for the 36-panel solar array, starting July 8, 2022."}
solar.data %>%
  group_by(day) %>%
