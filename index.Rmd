...
hmm, that's messy...  but it does show that once the solar system was online (July 8), and during daytimes, we typically drew directly from solar, thus zero kWh consumed from the grid.
