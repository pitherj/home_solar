...
Note that the low consumption in June is due to data gaps, which are also a mystery to Fortis. **Likewise**, we have a data gap between Feb 10 and March 2 2023!
...
all_data %>%
  ...
  theme_bw()
```
Note the data gap from Feb 10 through March 2, 2023.  This is problematic... i'm dealing with Fortis on this...
