...
This system is large for our current needs; we averaged about 10 thousand kWh a year in consumption, but with the new one-bedroom addition, and hopefully an EV in the next few years, the 12.96kW solar system should be ideal.  
...
Fortis BC has a [net metering program](https://www.fortisbc.com/services/electricity-services/generating-your-own-electricity/net-metering), in which any energy produced by the solar array that is not used immediately on site is put back into the grid.  The kicker is that Fortis only pays out $0.05/kWh for energy supplied to the grid. This is half of what BC Hydro pays out. So if you want to calculate what your return on investment would be for solar, be sure to think about this, and have a look at the [map of BC](https://www.bchydro.com/content/dam/BCHydro/customer-portal/documents/corporate/safety/bchydro-service-area-map.pdf) showing the distribution of electricity providers.  

* * *

## Start dates

We officially started producing solar power on July 8, 2022, and net metering started on July 15, 2022.  So, between July 8 and July 15, Fortis got free energy from us.  
...
hmm, that doesn't look great...  but it does show that, once the solar system was online (July 8), and during daytimes, we typically drew directly from solar, thus zero kWh consumed from the grid.
